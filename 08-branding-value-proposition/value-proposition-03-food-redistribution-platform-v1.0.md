...
> **입력** [챕터 04 TAM-SAM-SOM](../04-tam-sam-som/분석-03-식량-재분배-플랫폼.md) · [챕터 05 페르소나 스펙트럼](../05-persona-journey/분석-03-식량-재분배-플랫폼.md) · [고객 여정지도](../05-persona-journey/분석-03-식량-재분배-플랫폼.md) · [챕터 06 AOS](../06-opportunity-score/분석-03-식량-재분배-플랫폼.md) · [DOS](../06-opportunity-score/분석-03-식량-재분배-플랫폼.md) · [혼합 매트릭스](../06-opportunity-score/분석-03-식량-재분배-플랫폼.md) · [챕터 07 JTBD 결과](../07-jtbd/분석-03-식량-재분배-플랫폼.md) · [같은 챕터 — 경쟁사 가치선언](./경쟁사-가치선언-03-식량-재분배-플랫폼.md) · [가치목표 제안](./가치목표-제안-03-식량-재분배-플랫폼.md)
...
> [챕터 07 JTBD 요약 카드](../07-jtbd/분석-03-식량-재분배-플랫폼.md)에서 추출한 Situation + Job Statement.
...
> [경쟁사 가치선언 분석](./경쟁사-가치선언-03-식량-재분배-플랫폼.md) · 규모는 각 기관 공식 발표 기준 · **(확인)**
...
| 항목 | 한때의 판정 | 반증 | 출처 |
|---|---|---|---|
| **후원처 비교 단위**(P07) | AOS **4.0 · 1위** | 수요 측 — *"비교를 해야 한다는 생각을 안 해봤어요"* / 공급 측 — **GiveWell이 이미 제공** | [챕터 07](../07-jtbd/분석-03-식량-재분배-플랫폼.md) · [경쟁사 가치선언](./경쟁사-가치선언-03-식량-재분배-플랫폼.md) |
| **소액 증명 부재**(P14) | Sat **1** *(대체재 없음)* | ShareTheMeal이 **0.80달러 단위**로 목적지 지정 제공 | [경쟁사 가치선언 §4-3](./경쟁사-가치선언-03-식량-재분배-플랫폼.md) |
...
| 구성 요소 | 등급 | 비고 |
|---|---|---|
| §4 경쟁사 규모·모델·선언 | **(확인)** | 각 기관 공식 발표. 경쟁사 가치선언 분석의 검증 링크 |
