...
> 🗄️ **초안(superseded).** 이 문서는 **기준본이 아니다.** [`가치제안-03-식량-재분배-플랫폼.md`](./가치제안-03-식량-재분배-플랫폼.md)가 기준본이며, 이 판에서 살릴 서술은 그쪽으로 옮겼다.
>
> 이 파일을 남겨 두는 이유는 **기준본이 무엇을 고쳐서 그렇게 됐는지가 대조 없이는 보이지 않기 때문**이다. 확인된 결함 여섯 가지 — ① §1-2에 인물이 12명 중 10명만 있었다 ② O18·O21이 표에서 말없이 빠졌다 ③ §4가 대체재(Substitute) 표 없이 경쟁사만 다뤘다 ④ `P34·P35·P36`을 `O34·O35·O36`으로 잘못 적었다 ⑤ 결제 병목에 대한 서술이 §1-1과 §1-3에서 서로 어긋났다 ⑥ *"받은 사람의 서명"* 이 상위 문서의 *"인수 확인"* 보다 강한 약속이었다. **⑥은 특히 선언문을 반증 가능하게 만드는 과약속**이었고, 기준본에서 전부 정정됐다.
